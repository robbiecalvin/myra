import type { ParsedIntent } from "../types/recommendation.js";

const MAX_QUERY_LENGTH = 500;

const stylePatterns: Array<{ style: string; pattern: RegExp }> = [
...
const occasionPatterns: Array<{ occasion: string; pattern: RegExp }> = [
...
const parseStyle = (input: string): string => {
...
const parseOccasion = (input: string): string => {
...
const parseRegion = (input: string): string => {
